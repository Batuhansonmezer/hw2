...
actor9 = Actor.find_by({"name" => "Maggie Gyllenhaal"})
actor10 = Actor.find_by({"name" => "Tom Hardy"})
actor11 = Actor.find_by({"name" => "Joseph Gordon-Levitt"})
actor12 = Actor.find_by({"name" => "Anne Hathaway"})
